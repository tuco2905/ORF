...
def build_executable():
    ...
    - Cria uma pasta dist/monitoramento com o executável e arquivos de configuração (.env, lista_sites.json).
      No final, dist conterá apenas essa pasta.
    """
    ...
    final_dist_dir = DIST_DIR / SPEC_NAME
    ...
    # Remover quaisquer arquivos soltos em dist/, mantendo apenas a pasta "monitoramento"
